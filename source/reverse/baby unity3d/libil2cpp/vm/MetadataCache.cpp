...
void MetadataCache::Initialize()
{
    ...
    char* filename = decrypt_str("CLKFIL\rMETIDITI\nDIT",19);

    s_GlobalMetadata = vm::MetadataLoader::LoadMetadataFile(filename);
    free(filename);
    s_GlobalMetadataHeader = (const Il2CppGlobalMetadataHeader*)s_GlobalMetadata;
    IL2CPP_ASSERT(s_GlobalMetadataHeader->sanity == 0x23333333);
